...
def data_preprocessing(cfg: DictConfig):
    try:
        ...
        logger.info(f"Loaded interim data: Train shape {train_df.shape}, Test shape {test_df.shape}")
        ...
        logger.info("Starting Imputation and Handling of numerical/categorical features...")
        ...
        logger.info("Numerical and Categorical handling completed.")

        logger.info(f"Starting Encoding: Sex (Label) and Embarked (One-Hot)")
        ...
        logger.info(f"Encoding completed. New X_train shape: {X_train.shape}")
        ...
        logger.info("Preprocessing artifacts (encoders/handlers) saved to models/preprocessor.joblib")
